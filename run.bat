...
C:\gbdk\bin\lcc -Wl-yt3 -Wl-yo4 -Wl-ya4 -o dist/dist.gb dist/main.o dist/tilemap.o dist/bkgs.o dist/sprites.o dist/player.o dist/savevars.o dist/gb_helpers.o
